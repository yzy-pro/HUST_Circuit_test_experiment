...
\begin{longtable}{|c|p{2cm}|p{2.5cm}|p{4.5cm}|p{4cm}|}
    ...
    \endlastfoot
        ...
        \hline
        5 & 学习输入耦合方式的影响 & 波形：正方波 \newline 频率：400Hz \newline 峰峰值：6V \newline 偏置：3V & 工作方式：YT \newline 三个通道连接同一个输入信号 \newline CH1：5V/div，交流耦合 \newline CH2：5V/div，直流耦合 \newline CH3：5V/div，接地耦合 & 同一坐标系下绘制 CH1、CH2、CH3 三个波形  \\
        \hline
...
\cline{4-6}
 &  &  & $U_{Lm}$ & $U_{rm}$ & $\varphi_{u-i}$ &  \\
\hline
1 & $u_s = 5\sin 100\pi t$ & $R=200\Omega$ & \rule{0pt}{3ex} & & & \\
\hline
2 & $u_s = 5\sin 100\pi t$ & $C=2.2\mu F$ & \rule{0pt}{3ex} & & & \\
\hline
